				...
				<div class="movie-browse-agile">
					...
					<div class="browse-agile-w3ls general-w3ls">
						<div class="tittle-head">
							<h4 class="latest-text">${movieType} </h4>
							<div class="container">
						...
						<div class="container">
							<div class="browse-inner">
								...
								<c:if test="${!empty moviesEqType}">
									<c:forEach begin="0" end="23" items="${moviesEqType}" var="movieEqType">
										<div class="col-md-2 w3l-movie-gride-agile">
											<a href="movieDetail.do?movieID=${movieEqType.movieid}" class="hvr-shutter-out-horizontal"><img src="<%=staticPath %>/images/${movieEqType.movieid}.jpg" title="album-name" alt=" " />
												<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
											</a>
											<div class="mid-1">
												<div class="w3l-movie-text">
													<h6><a href="movieDetail.do?movieID=${movieEqType.movieid}">${movieEqType.moviename}</a></h6>
												</div>
												<div class="mid-2">
		
													<p>${fn:split(movieEqType.movieupdatedate,"-")[0]}</p>
													<div class="block-stars">
														<span>${movieEqType.moviescore}</span>
													</div>
